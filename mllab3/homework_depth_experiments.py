...
if __name__ == '__main__':
    ...
    configs = [{"input_size": 784,"num_classes": 10,"layers": [{"type": "linear", "size": 512},{"type": "relu"},{"type": "linear", "size": 256},{"type": "relu"}, {"type": "linear", "size": 128},
        ...
        {"type": "relu"},{"type": "dropout", "rate": 0.3},{"type": "linear", "size": 10},{"type": "sigmoid"} ]},                 #2 слоя dropout
    ...
    for config in configs:
        ...
        train_dl, test_dl = get_cifar_loaders(batch_size=512)
        cifar_history = train_model(model,train_dl, test_dl,epochs=5, lr=0.001, device='cuda')
